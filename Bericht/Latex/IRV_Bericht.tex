...
Jede betrachtete Variable wird nebeneinander angeordnet. Alle dazugehörigen Datenwerte werden über eine Linie minenander verbunden \cite{Moustafa.2006}. ( Rida)
...
Dabei sind die Achsen parallel zueinader angeordnet. Parallele Koordinaten bieten einen giten Datenüberblick. Eine Gefahr stellt allerdings die Überlappung von Linen dar, wenn zu viele Daten verwendet werden \cite{Heinrich.2009}. (Heinrich) 
