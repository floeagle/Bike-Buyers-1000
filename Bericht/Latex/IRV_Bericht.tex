...
Somit stellt diese rasante Entwicklung die Fahrradbranche vor Herausforderungen, die Kundenwünsche richtig umzusetzen. Unübrsichtliche Lieferantentermine und der Onilinehandel erschweren die Kundenbeziehung. Diese Arbeit möchte diese Probleme durch gezielte Visualisierung von Kundendaten zum Thema Fahrradkauf für verschiedene Branchenbereiche lösen. Im Rahmen dieser Arbeit wird zur Veranschaulichung auf  Visualisierungstechniken wie den Scatterplot, Parallele Koordinaten und das Baumdiagramm zurückgegriffen. Durch diese Darstellungen sollen Zusammenhänge aufgezeigt werden, welche zu Fahrradkäufen führen und durch die Anwendende einen Mehrwert für Ihren Geschäftsbereich ableiten können. 
