...
Für die erste Darstellung wurde der Scatterplot gewählt. Die in der Einleitung beschriebenen Merkmale, wie 
...
\caption{Parallele Korrdinaten für Bike Buyers, Quelle: Eigene Darstellung}
\end{center}
\end{figure}
text
